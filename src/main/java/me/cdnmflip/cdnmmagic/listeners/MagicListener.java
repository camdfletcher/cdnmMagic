...
public interface MagicListener extends Listener {
    ...
    /**
     * Helper method that validates whether a {@link MagicItem} is valid in the context of a {@link Listener}
     *
     * @param magicItem The {@link MagicItem} that is being validated
     * @param player The {@link Player} who is in possession of the {@link org.bukkit.inventory.ItemStack} that is being checked
