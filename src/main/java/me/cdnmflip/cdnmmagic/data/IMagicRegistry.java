...
public interface IMagicRegistry {
  ...
  /**
   * Handle all loading of data that will be needed here Ideally {@link MagicItem} should be loaded
   * in here
   *
   ...
   *
   * Ideal for any cleanup of repeating tasks or any other passive actions that may not have been
   * ended
   */
  void unloadMagic();
   ...
   * @return An {@link Optional} containing the retrieved instance of {@link MagicItem} (if
   * existing)
   */
